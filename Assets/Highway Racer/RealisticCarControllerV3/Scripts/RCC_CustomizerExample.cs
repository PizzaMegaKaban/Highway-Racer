...
public class RCC_CustomizerExample : RCC_Singleton<RCC_CustomizerExample> {
    ...
    public void ResetStats() {
        ...
        RCC_Customization.ResetStats(HR_MainMenuHandler.Instance.currentCar, HR_PlayerCars.Instance.cars[HR_MainMenuHandler.Instance.carIndex].playerCar.GetComponent<RCC_CarControllerV3>());
